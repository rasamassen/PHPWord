...
- Writer RTF: Fix font/color not being added to header tables if located in subelements like textRun by [@rasamassen](https://github.com/rasamassen) in [#2818](https://github.com/PHPOffice/PHPWord/pull/2818)
